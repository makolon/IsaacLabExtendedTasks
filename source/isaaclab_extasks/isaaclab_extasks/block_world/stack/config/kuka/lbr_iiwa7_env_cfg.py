...
from isaaclab_exassets.kuka import LBR_IIWA7_SCHUNK_WSG_50_CFG  # isort: skip
from isaaclab_extasks.block_world.stack.stack_env_cfg import StackEnvCfg


@configclass
class LBRIIWA7StackEnvCfg(StackEnvCfg):
...
@configclass
class LBRIIWA7StackEnvCfg_PLAY(LBRIIWA7StackEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
