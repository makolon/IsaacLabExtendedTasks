...
from omni.isaac.extended_assets.kinova import KINOVA_GEN3_N7_CFG  # isort: skip


@configclass
class Gen3N7CookingEnvCfg(CookingEnvCfg):
    def __post_init__(self):
        ...
        self.commands.object_pose.body_name = "gen3_hand"
        ...
        self.scene.ee_frame = FrameTransformerCfg(
            ...
            target_frames=[
                FrameTransformerCfg.FrameCfg(
                    prim_path="{ENV_REGEX_NS}/Robot/gen3_hand",
                    name="end_effector",
                    offset=OffsetCfg(
                        pos=[0.0, 0.0, 0.1034],
                    ),
...
@configclass
class Gen3N7CookingEnvCfg_PLAY(Gen3N7CookingEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
