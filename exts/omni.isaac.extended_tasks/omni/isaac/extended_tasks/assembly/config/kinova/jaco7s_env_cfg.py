...
from omni.isaac.extended_assets.kinova import KINOVA_JACO_7S_CFG  # isort: skip
from omni.isaac.extended_tasks.assembly import FUSION360_FIXTURE_PATH, FUSION360_OBJECT_PATH  # isort: skip


@configclass
class Jaco7SAssemblyEnvCfg(AssemblyEnvCfg):
    def __post_init__(self):
        ...
        self.scene.ee_frame = FrameTransformerCfg(
            prim_path="{ENV_REGEX_NS}/Robot/j2s7n300_link_base",
            debug_vis=False,
            visualizer_cfg=marker_cfg,
            target_frames=[
                FrameTransformerCfg.FrameCfg(
                    prim_path="{ENV_REGEX_NS}/Robot/j2s7n300_end_effector",
                    name="end_effector",
                    offset=OffsetCfg(
                        pos=[0.0, 0.0, 0.1034],
                    ),
...
@configclass
class Jaco7SAssemblyEnvCfg_PLAY(Jaco7SAssemblyEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
