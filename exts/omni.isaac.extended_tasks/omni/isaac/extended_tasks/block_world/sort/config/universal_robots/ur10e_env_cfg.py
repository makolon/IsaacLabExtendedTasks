...
from omni.isaac.extended_assets.universal_robots import UR10E_ROBOTIQ_2F_140_CFG  # isort: skip


@configclass
class UR10eSortingEnvCfg(SortingEnvCfg):
...
@configclass
class UR10eSortingEnvCfg_PLAY(UR10eSortingEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
