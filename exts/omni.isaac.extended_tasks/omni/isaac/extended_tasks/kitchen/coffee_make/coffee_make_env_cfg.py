...
@configclass
class CoffeeMakeSceneCfg(InteractiveSceneCfg):
...
@configclass
class CoffeeMakeEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the assembly environment."""

    # scene settings
    scene: CoffeeMakeSceneCfg = CoffeeMakeSceneCfg(num_envs=4096, env_spacing=2.5)
    # basic settings
